...
class RegisterNameAliasModal extends React.Component{
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
  ...
  render() {
    ...
    return (
      <>
        <Modal 
      contentClassName={modalBkg} backdropClassName={modalBackdrop} 
      show={this.props.isModalShowing} >
        <Modal.Header >
          <Modal.Title>Purchase Dash Name (Alias)</Modal.Title>
          {closeButtonColor}
        </Modal.Header>
        <Modal.Body>
          <Form
            ...
            {this.state.isLoading ?
              ...
              {this.state.isError ? (
                <Alert variant="warning">
                  Testnet Platform is having difficulties... or the identity has insufficient credits or the name is already taken...
                </Alert>
              ) : (
                <></>
              )}
              ...
              <p></p>
                ...
                <ul>
                  <li>
                    A name can consist of any combination of letters (UPPERCASE or
                    lowercase) and numbers with one hyphen (-) anywhere in the
                    middle.
                  </li>
...
export default RegisterNameAliasModal;
