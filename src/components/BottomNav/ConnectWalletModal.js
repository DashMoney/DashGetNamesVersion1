        ...
        <Modal.Body>
          ...
          >
            ...
            {/* numberOfLocalForageKeys */}
             ...
             {this.props.numberOfLocalForageKeys===0 ?
            <>
            ...
            <Form.Text className="text-muted">
                <p></p>
                {/* <h5>Experimental Feature - New Wallet Connect</h5> */}
                <p>New Wallet means the first transaction to this wallet was less than 3 days ago.
                  <b> New Wallet</b> login only takes several seconds. <b>Full Sync</b> may take a minute...
                </p>
                {/* <p>Please let me know what you think of the feature and if its faster for you. -DashMoney</p> */}
                </Form.Text>
            </>
            :
